			...
			<div id="page_content_inner">
				<div id="page_middle_content">
					<div id="main_panel">
						...
						<div class="center_content">
							<div class="login_field">
								<span id="email_label" class="label">E-mail:<span
									class="req">*</span></span> <input name="email_input" type="text"
									id="text_ident" tabindex="1" required autocomplete="off"><br>
							</div>
							<div class="login_field">
								<span id="pswd_label" class="label">Password:<span
									class="req">*</span></span> <input type="password" id="txtpswd"
									tabindex="2" required autocomplete="off"><br>
							</div>
						...
						<div class="center_content">
							<div id="loginAs" class="login_as">
								<span id="label5" class="label"
									style="border-color: Transparent;">Sign in as:</span>
								<table id="who" size="10" border="0">
									<tbody>
										<tr>
											<td><input id="who_0" type="radio" name="who"
												value="user" checked="checked" tabindex="3"> <label
												for="who_0">user</label></td>
											<td><input id="who_1" type="radio" name="who"
												value="admin" tabindex="3"> <label for="who_1">admin</label>
											</td>
										</tr>
									</tbody>
								</table>
